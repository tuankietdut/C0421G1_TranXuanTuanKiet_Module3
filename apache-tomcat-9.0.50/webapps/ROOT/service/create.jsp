            ...
            <form action="/service" method="post">
                <div class="mb-3">
                    ...
                    <select onchange="onchangeService()"class="form-control" name="serviceType" id="changeService">
                        <c:forEach items="${serviceType}" var="serverTypeObj">
                            <c:choose>
                                <c:when test="${service.typeService.equals(serverTypeObj.name)}">
                                    <option value="${serverTypeObj.id}" selected>${serverTypeObj.name}</option>
                                </c:when>
                                <c:otherwise>
                                    <option value="${serverTypeObj.id}">${serverTypeObj.name}</option>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="Service_area" name="Service_area" value="${service.area}">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="service_cost" name="service_cost" value="${service.cost}">
                    <div class="form-text text-danger">${errorCost}</div>
                </div>

                <div class="mb-3">
                    <label for="service_max_people" class="form-label">Service_max_people</label>
                    <input type="number" class="form-control" id="service_max_people" name="service_max_people" value="${service.maxPeople}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="standard_room" name="standard_room" value="${service.standardRoom}">
                </div>

                <div class="mb-3">
                    <label for="description_other_convenience" class="form-label">Description_other_convenience</label>
                    <input type="text" class="form-control" id="description_other_convenience" name="description_other_convenience" value="${service.description}">
                </div>

                <div class="mb-3">
                    <label for="pool_area" class="form-label">Pool_area</label>
                    <input type="number" class="form-control" id="pool_area" name="pool_area" value="${service.poolArea}">
                    <div class="form-text text-danger">${errorPoolArea}</div>
                </div>

                <div class="mb-3">
                    <label for="number_of_floors" class="form-label">Number_of_floors</label>
                    <input type="number" class="form-control" id="number_of_floors" name="number_of_floors" value="${service.floor}">
