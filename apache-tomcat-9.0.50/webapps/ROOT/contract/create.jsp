...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-9 col-sm-12">
            ...
            <h1 class="display-6 text-center">Create Contract</h1>
            ...
            <form action="/contract" method="post">
                ...
                <div class="mb-3">
                    <label for="deposit" class="form-label">Deposit_money</label>
                    <input type="number" class="form-control" id="deposit" name="deposit">
                </div>

                <div class="mb-3">
                    <label for="total" class="form-label">Total_money</label>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="employeeId" id="employeeId">
                        <c:forEach items="${employeeList}" var="employeeObj">
                            <option value="${employeeObj.id}">${employeeObj.name} ||  iD_employee = ${employeeObj.id}</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="serviceId" id="serviceId">
                        <c:forEach items="${serviceList}" var="serviceObj">
                            <option value="${serviceObj.id}">${serviceObj.name} || iD_service = ${serviceObj.id}</option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" name="customerId" id="customerId">
                        <c:forEach items="${customerList}" var="customerObj">
                            <option value="${customerObj.id}">${customerObj.name} ||  iD_customer = ${customerObj.id}</option>
                        </c:forEach>
                    </select>
                </div>
